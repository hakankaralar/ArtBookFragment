...
import com.hakankaralar.artfragment.databinding.FragmentDetailsBinding;
import com.hakankaralar.artfragment.model.Art;
import com.hakankaralar.artfragment.roomdb.ArtDao;
import com.hakankaralar.artfragment.roomdb.ArtDatabase;
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU){
            if(ContextCompat.checkSelfPermission(requireContext(), Manifest.permission.READ_MEDIA_IMAGES) != PackageManager.PERMISSION_GRANTED){
                if(ActivityCompat.shouldShowRequestPermissionRationale(requireActivity(),Manifest.permission.READ_MEDIA_IMAGES)){
                    Snackbar.make(view,"Permission need for gallery! ",Snackbar.LENGTH_INDEFINITE).setAction("Permission Needed!", new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            //request permission
